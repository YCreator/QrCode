...
public class SharedPreferencesUtils {
     ...
     * return
     */
    public void encryptSave(String key, String value) throws Exception {
        SharedPreferences.Editor editor = getShare().edit();
     ...
     * return
     */
    public String decryptLoad(String key) throws Exception {
        String str = getShare().getString(key, "");
        return !"".equals(str) ? AESEncryptor.decrypt(MAK, str) : "";
    }
